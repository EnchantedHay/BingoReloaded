...
//        setOptionValue(ConfigurationOption.USE_INCLUDED_RESOURCE_PACK, config.getBoolean("useIncludedResourcePack", true));
        ...
        setOptionValueForce(BingoOptions.WORLD_RESET_GAME_WORLD_NAME, name -> config.getString(name, "bingo_game"));
        setOptionValueForce(BingoOptions.WORLD_RESET_PRELOAD_RADIUS, name -> config.getInt(name, 256));
        setOptionValueForce(BingoOptions.WORLD_RESET_RANDOM_SEED, name -> config.getBoolean(name, true));
        setOptionValueForce(BingoOptions.WORLD_RESET_SCATTER_RADIUS, name -> config.getInt(name, 64));
        setOptionValueForce(BingoOptions.WORLD_RESET_SCATTER_JITTER, name -> config.getInt(name, 16));
        setOptionValueForce(BingoOptions.WORLD_RESET_SCATTER_MAX_TRIES, name -> config.getInt(name, 16));
    }

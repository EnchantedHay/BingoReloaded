...
public final class StatisticType implements Keyed {

	public static final StatisticType KILL_ENTITY = StatisticType.of(Key.key("minecraft", "kill_entity"));
	public static final StatisticType ENTITY_KILLED_BY = StatisticType.of(Key.key("minecraft", "entity_killed_by"));

	public static final Map<Statistic, StatisticCategory> STATISTIC_CATEGORY_MAP = makeStatisticMap();
	...
	private static Map<Statistic, StatisticCategory> makeStatisticMap() {
		...
		for (var stat : Statistic.values()) {
			map.put(stat, new StatisticType(stat).getCategory());
		}
		return map;
	}
	...
	public StatisticType(Statistic stat) {
		this.stat = stat;
	}

	public static @Nullable StatisticType of(Key key) {
		Statistic stat = Registry.STATISTIC.get(key);
		if (stat == null) {
			return null;
		}
		return new StatisticType(stat);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof StatisticType other) {
